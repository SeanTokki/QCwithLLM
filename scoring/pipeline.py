...
def make_full_result(naver_id: str, result: Dict[str, Any]) -> Optional[FullResult]:
    ...
    full_result = FullResult(
        ...
        inn_reason_caps=img_res.first_reason_captions,
        inn_reason_imgs=img_res.first_reason_images,
        seat_score=img_res.second_score,
        seat_reason=img_res.second_reason,
        seat_reason_caps=img_res.second_reason_captions,
        seat_reason_imgs=img_res.second_reason_images,
